...
export async function firstStepLogin(username, password) {
  ...
  console.log(baseUrlNew + "authorization/login");
  return axios
    .post(baseUrlNew + "authorization/login", loginPayload)
    .then((res) => {
      return {
...
export function changePassword(userName, oldPassword, newPassword) {
  return axios
    .post(baseUrlNew + "authorization/change-password", {
      user_name: userName,
...
export function resetPassword(email, newPassword, otp) {
  return axios
    .post(baseUrlNew + "authorization/reset-password", {
      email: email,
...
export function generateOtp(email) {
  return axios
    .post(baseUrlNew + "authorization/generate-otp", {
      email: email,
    })
    .catch(globalErrorHandler);
}
